#!/usr/bin/env python3
"""
Process cubemap images through DA3-streaming to generate aligned point cloud.

This script runs DA3-streaming on cubemap images to produce:
...
def process_cubemap_to_pointcloud(
    input_dir: str,
    output_dir: str = None,
    chunk_size: int = 60,
    overlap: int = 30,
...
Examples:
    ...
    parser.add_argument(
        "--input", "-i",
        required=True,
        help="Input directory containing cubemap images"
    )
    parser.add_argument(
        "--output", "-o",
        default=None,
    ...
    result = process_cubemap_to_pointcloud(
